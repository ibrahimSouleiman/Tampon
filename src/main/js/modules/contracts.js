...
function updateExchanges($scope){
 $scope.choice = $scope.form.addHow;
   console.log($scope.choice.length+" "+checkExchanges($scope));
    if (checkExchanges($scope) == true)
{
   console.log($scope.choice.length);
   // delivery
...
$scope.exchangesStr=[];
console.log("Dans BuildStr="+$scope.exchanges.length+ " "+$scope.exchanges);
